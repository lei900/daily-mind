...
class EntryDashboard < Administrate::BaseDashboard
  ...
  COLLECTION_ATTRIBUTES = %i[id community entryable status].freeze
  ...
  FORM_ATTRIBUTES = %i[community entryable status user user_uid].freeze
